        ...
        <div className="mx-auto flex w-full max-w-5xl flex-1 flex-col gap-4">
          <div className="flex flex-col gap-1">
            ...
            <div className="text-sm text-muted-foreground">
              Registra tus gastos y revisa el historial del mes.
            </div>
          </div>
          ...
          <Dialog open={addOpen} onOpenChange={setAddOpen}>
            <DialogContent className="sm:max-w-md rounded-2xl">
              <DialogHeader>
                ...
                <DialogDescription>
                  Completa los datos para registrar tu egreso.
                </DialogDescription>
              </DialogHeader>
                ...
                <div className="min-w-[680px] overflow-hidden rounded-2xl border border-input bg-background/70 shadow-sm ring-1 ring-border">
                  ...
                  <div className="divide-y divide-border">
                    {items.map((it) => (
                      ...
                      >
                        <div className="col-span-3 text-right font-semibold tabular-nums text-destructive">
